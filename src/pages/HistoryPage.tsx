...
export default function HistoryPage() {
  ...
  // Modal accessibility: focus trap, scroll lock, restore focus
  useEffect(() => {
    if (!viewing) return;
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="flex shrink-0 flex-col gap-1.5">
                            <button
                              ...
                              className="rounded-lg px-3 py-2 text-sm font-semibold text-slate-500 hover:bg-slate-100 hover:text-slate-800 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200 min-h-[44px]"
                            >
                              {t("hist_edit")}
                            </button>
                            {confirmDelete === e.date ? (
                              <button
                                ...
                                className="rounded-lg bg-red-600 px-3 py-2 text-sm font-semibold text-white hover:bg-red-500 min-h-[44px]"
                              >
                              ...
                              <button
                                ...
                                className="rounded-lg px-3 py-2 text-sm font-semibold text-red-500 hover:bg-red-50 dark:hover:bg-red-950/40 min-h-[44px]"
                              >
                                {t("hist_delete")}
                              </button>
                            )}
          ...
          >
            <div className="flex items-start justify-between gap-3">
              ...
              <button
                ...
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full text-slate-500 transition-colors hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800 min-h-[44px] min-w-[44px]"
              >
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-indigo-500 min-h-[44px]"
              >
                {t("hist_edit")}
              </button>
              <button
                ...
                className="rounded-xl bg-red-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-red-500 min-h-[44px]"
              >
                {t("hist_delete")}
              </button>
              <button
                type="button"
                onClick={() => setViewing(null)}
                className="rounded-xl border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-600 transition-colors hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 min-h-[44px]"
              >
                {t("hist_close")}
              </button>
            </div>
