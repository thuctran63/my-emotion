...
const dict: Dict = {
  ...
  stats_insight_month: { vi: "Tháng vui nhất", en: "Happiest month" },
  stats_insight_trend: { vi: "Xu hướng", en: "Trend" },
  stats_insight_streak: { vi: "Chuỗi dài nhất", en: "Best streak" },
  stats_insight_30d: { vi: "TB 30 ngày", en: "30-day avg" },
  stats_trend_up_short: { vi: "Đi lên", en: "Up" },
  stats_trend_down_short: { vi: "Đang giảm", en: "Down" },
  stats_trend_steady_short: { vi: "Ổn định", en: "Steady" },
